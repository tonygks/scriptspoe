		...
		For i, element in this.ClassType
		{
			If (t_ClassType == element)
			{
				If ((this.PhysDPS[i]) and (Item.CraftPhysDPS > this.PhysDPS[i]))
				{
					...
					Item.Success := True
					TT_Result := "`n--------------------------------------`nPhysDPS:	" . TT_Result . "`nElemDPS:	" . Item.ElemDPS . "`nAPS:		" . Item.CraftedAPS . "`nCrit:		" . Item.WeaponCrit . "`n--------------------------------------"
				...
				If (this.ElemDPS[i]) and (Item.CraftElemDPS > this.ElemDPS[i])
				{
					...
					Item.Success := True
					TT_Result := "`n--------------------------------------`nPhysDPS:	" . Item.PhysDPS . "`nElemDPS:		" . TT_Result . "`nAPS:		" . Item.CraftedAPS . "`nCrit:		" . Item.WeaponCrit . "`n--------------------------------------"
					TT_ResultExt := TT_Result
					return True
				}
