					...
					If (Item.CraftPhysDPSHi > this.PhysDPS[i]) 
					{
						If (Item.CraftPhysDPSHi > Item.PhysDPS)
						{
							...
							If InStr(TT_PhysCraftMods, "IAS")
								...
								TT_CraftAPS := "`nAPS:		" . Item.CraftAPSLo
							If InStr(TT_MultiCraftMods, "IAS")
								TT_MultiAPS := "`nAPS:		" . Item.MultiAPSLo . "-" . Item.MultiAPSHi
							else
								TT_MultiAPS := "`nAPS:		" . Item.MultiAPSLo
							
							t_CraftFlag := True
						}
						Item.Success := True
						TT_PhysDPS := "`n--------------------------------------`n[Craft]" . TT_PhysCraftDPS . TT_CraftAPS . "`n--------------------------------------`n[MultiCraft]" . TT_PhysMultiDPS . TT_MultiAPS
					}
