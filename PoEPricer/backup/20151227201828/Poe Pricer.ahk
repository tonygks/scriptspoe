			...
			If (t_ClassType == element)
			{
				...
				If (this.PhysDPS[i])
				{
					If (Item.CraftPhysDPSHi > this.PhysDPS[i]) 
					{
						...
						Item.Success := True
						TT_CraftPhysDPS := "`n--------------------------------------`n[Craft]" . t_PhysCraftDPS . t_CraftAPS . "`n--------------------------------------`n[MultiCraft]" . t_PhysMultiDPS . t_MultiAPS
					}
				...
				TT_CraftPhysDPS := "`nPhysDPS:	" . Item.PhysDPS . "`nAPS:		" . Item.APS . TT_PhysDPS
